...
describe("Simple AND operator", () => {
    ...
    test("test1", () => {
        ...
        expect(result.sqlString).toEqual(
            /*sql*/ `(upper(PROJECT_CODE) = upper(PROJECT_CODE) AND upper(WORKLIST_ID) > :1)`
        );
    ...
    test("test2", () => {
        ...
        expect(result.sqlString).toEqual(
            /*sql*/ `(upper(PROJECT_CODE) = upper(PROJECT_CODE) AND (1, upper(WORKLIST_ID)) IN ((1, :1),(1, :2),(1, :3),(1, :4),(1, :5)))`
        );
    ...
    test("test3 group in group", () => {
        ...
        expect(result.sqlString).toEqual(
            /*sql*/ `((upper(PROJECT_CODE) = upper(PROJECT_CODE) AND upper(WORKLIST_ID) > :1) AND (upper(PROJECT_CODE) = PROJECT_CODE AND upper(WORKLIST_ID) > :2))`
        );
